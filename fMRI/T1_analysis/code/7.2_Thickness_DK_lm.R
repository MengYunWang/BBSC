...
# 3. Calculate the percentage change in the thickness
...
# percentage_change_thickness <- percentage_change
# save (percentage_change_thickness, file = "percentage_change_thickness.RData")
...
# percentage_change_thickness_long <- percentage_change_long
# save(percentage_change_thickness_long, file="percentage_change_thickness_long.RData")
