...
### ---------------------------------Part III calculate the absolute percentage change of volume
...
# percentage_change_volume <- percentage_change
# save (percentage_change_volume, file = "percentage_change_volume.RData")
...
# percentage_change_volume_long <- percentage_change_long
# save(percentage_change_volume_long, file="percentage_change_volume_long.RData")
