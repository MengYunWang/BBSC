...
# save the plots for the reuse to plot Fig. 5
# save(plots_brain_cv, file = "plots_brain_area_cv_orig.RData")
# save(plots_brain_mean, file = "plots_brain_area_mean_orig.RData") # save it for reuse

plots_brain_cv_qc <- plots_brain_cv
plots_brain_mean_qc <- plots_brain_mean
save(plots_brain_cv_qc, file = "plots_brain_area_cv_qc.RData")
save(plots_brain_mean_qc, file = "plots_brain_area_mean_qc.RData") # save it for reuse
...
# save the plot
# save(plots_list_box, file = "plots_brain_area_per_change_orig.RData")

plots_list_box_qc <- plots_list_box
save(plots_list_box_qc, file = "plots_brain_area_per_change_qc.RData")
