...
#----------------------------------Load the data
# generated from 7.2
percentage_change_thickness <- read.csv("percentage_change_thickness.csv", row.names = 1)
...
plots_time_thickness_sub1 <- generate_plots_for_subject("sub1")
plots_time_thickness_sub2 <- generate_plots_for_subject("sub2")
plots_time_thickness_sub3 <- generate_plots_for_subject("sub3")
...
thickness_half1 <- combine_plots_for_range(1, 11, plots_time_thickness_sub1, plots_time_thickness_sub2, plots_time_thickness_sub3)
thickness_half2 <- combine_plots_for_range(12, 22, plots_time_thickness_sub1, plots_time_thickness_sub2, plots_time_thickness_sub3)
thickness_half3 <- combine_plots_for_range(23, 34, plots_time_thickness_sub1, plots_time_thickness_sub2, plots_time_thickness_sub3)

thickness_time <- (thickness_half1 | thickness_half2 | thickness_half3) + plot_layout(guides = 'collect')
...
ggsave("/Users/wang/Library/CloudStorage/OneDrive-UniversityofBergen/Desktop/UiB/Manuscripts/BBSC/4.T1w_Image/Figures/FigS1.tiff",
       plot = thickness_time, width = 27, height = 40, units = 'in', dpi = 300, compression = "lzw")

# ggsave("/Users/joeywang/Library/CloudStorage/OneDrive-UniversityofBergen/Desktop/UiB/Manuscripts/BBSC/4.T1w_Image/Figures/FigS1.tiff",
#        plot = thickness_time, width = 27, height = 40, units = 'in', dpi = 300, compression = "lzw")
