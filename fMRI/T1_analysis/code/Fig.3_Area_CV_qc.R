...
plots_brain_area_cv_qc[[1]] <- plots_brain_area_cv_qc[[1]] +
  ...
  scale_fill_viridis_c(option = "plasma", direction = 1, limits = c(0, 8), breaks = c(2, 4, 6), labels = c("2", "4", "6"))


plots_brain_area_cv_qc[[2]] <- plots_brain_area_cv_qc[[2]] + 
...
plots_brain_area_per_change_qc[[1]] <- plots_brain_area_per_change_qc[[1]] + theme(axis.text.y = element_text(size = 18, family = "Arial",
                                                                              face = "bold", colour = "black"),
                                                   plot.margin = margin(t = 30, r = 2, b = 10, l = 2, unit = "pt"),
                                                   legend.position = "none")

plots_brain_area_per_change_qc[[2]] <- plots_brain_area_per_change_qc[[2]] + theme(axis.text.y = element_blank(), 
                                                   plot.margin = margin(t = 30, r = 2, b = 10, l = 2, unit = "pt"),
                                                   legend.position = "none")


plots_brain_area_per_change_qc[[3]] <- plots_brain_area_per_change_qc[[3]] + theme(axis.text.y = element_blank(), 
                                                         legend.title = element_blank(), 
...
Fig3 <- plots_brain_area_cv_qc[[1]] + plots_brain_area_cv_qc[[2]] + plots_brain_area_cv_qc[[3]] +
  plots_brain_area_per_change_qc[[1]] + plots_brain_area_per_change_qc[[2]] + plots_brain_area_per_change_qc[[3]] + plot_layout(ncol = 3)

ggsave("/Users/wang/Library/CloudStorage/OneDrive-UniversityofBergen/Desktop/UiB/Manuscripts/BBSC/4.T1w_Image/Figures/Fig3.tiff", 
       plot = Fig3, width = 13, height = 12, units = 'in', dpi = 300, compression = "lzw")

# ggsave("/Users/joeywang/Library/CloudStorage/OneDrive-UniversityofBergen/Desktop/UiB/Manuscripts/BBSC/4.T1w_Image/Figures/Fig5.tiff", 
       # plot = Fig5, width = 16, height = 12, units = 'in', dpi = 300, compression = "lzw")

######## ----------------------------- ----------------------another way to plot
# rm(list=ls())
# load("brain_area_per_change_qc.RData")
# load("brain_area_per_change_orig.RData")
# load("brain_area_cv_qc.RData")
# load("brain_area_cv_orig.RData")
# 
...
# 
# plots_brain_cv[[3]] <- plots_brain_cv[[3]] +
#   scale_fill_viridis_c(option = "plasma", direction = 1, limits = c(0, 6), breaks = c(0, 3, 6), labels = c("0", "3", "6")) +
#   theme(plot.margin = margin(t = 30, r = 2, b = 10, l = 2, unit = "pt"), legend.position = "none")
# 
