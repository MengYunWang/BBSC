...
# This code is to plot the Fig.6
...
#-------------------------plot the left side Fig.6AB
load("plots_brain_volume_mean_qc.RData") 
load("plots_volume_ordered.RData")
...
plots_volume_mean_ordered <- plots_brain_mean_qc[[1]] + plots_brain_mean_qc[[2]] + plots_brain_mean_qc[[3]] +
  (plots_volume_ordered[[1]] + theme (plot.margin = margin(t = 0, r = 10, b = 10, l = 5, unit = "pt")))+
  plot_layout(ncol = 1)
...
#---------------plot the right bottom Fig.6DEF
...
Fig6 <- plots_volume_mean_ordered | (plots_volume_qc + plots_volume_time[[1]] +
...
ggsave("/Users/wang/Library/CloudStorage/OneDrive-UniversityofBergen/Desktop/UiB/Manuscripts/BBSC/4.T1w_Image/Figures/Fig6.tiff",
       plot = Fig6, width = 15, height = 9.8, units = 'in', dpi = 300, compression = "lzw")
