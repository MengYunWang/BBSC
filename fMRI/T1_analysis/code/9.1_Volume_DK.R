...
# plots_brain_volume_cv_orig <- plots_brain_cv
# plots_brain_volume_mean_orig <- plots_brain_mean
# save(plots_brain_volume_cv_orig, file = "plots_brain_volume_cv_orig.RData")
# save(plots_brain_volume_mean_orig, file = "plots_brain_volume_mean_orig.RData") # save it for reuse

plots_brain_volume_cv_qc <- plots_brain_cv
plots_brain_volume_mean_qc <- plots_brain_mean
save(plots_brain_volume_cv_qc, file = "plots_brain_volume_cv_qc.RData")
...
# plots_brain_volume_per_change_orig <- plots_list_box
# save(plots_brain_volume_per_change_orig, file = "plots_brain_volume_per_change_orig.RData")

plots_brain_volume_per_change_qc <- plots_list_box
save(plots_brain_volume_per_change_qc, file = "plots_brain_volume_per_change_qc.RData")
