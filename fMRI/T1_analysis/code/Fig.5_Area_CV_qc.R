...
plots_brain_cv[[3]] <- plots_brain_cv[[3]] + 
  ...
  theme(axis.text.y = element_blank(), 
        plot.margin = margin(t = 30, r = 2, b = 10, l = 60, unit = "pt"),
        legend.position = "none") +
  scale_fill_viridis_c(option = "plasma", direction = 1, limits = c(0, 8), breaks = c(2, 4, 6), labels = c("2", "4", "6"))

plots_brain_cv_qc[[3]] <- plots_brain_cv_qc[[3]] +
  annotate("text", x = Inf, y = Inf, label = "Sub3_qc", vjust = 0, hjust = 1.5, family = "Arial", fontface = "bold", size = 8) +
...
plots_list_box[[2]] <- plots_list_box[[2]] + theme(axis.text.y = element_blank(), 
                                                   plot.margin = margin(t = 30, r = 2, b = 10, l = 2, unit = "pt"),
                                                   legend.position = "none")
...
Fig5 <- plots_brain_cv[[1]] + plots_brain_cv[[2]] + plots_brain_cv[[3]] + plots_brain_cv_qc[[3]] +
  plots_list_box[[1]] + plots_list_box[[2]] + plots_list_box[[3]]+ plots_list_box_qc[[3]] + plot_layout(ncol = 4)

ggsave("/Users/wang/Library/CloudStorage/OneDrive-UniversityofBergen/Desktop/UiB/Manuscripts/BBSC/4.T1w_Image/Figures/Fig5.tiff", 
