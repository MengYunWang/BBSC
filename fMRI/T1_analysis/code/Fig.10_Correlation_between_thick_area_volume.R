...
# generated from 9.2
percentage_change_volume <- read.csv("percentage_change_volume.csv", row.names = 1)
...
corr_thick_area <-  cor(percentage_change_thickness[, 1:34], percentage_change_area[, 1:34])
corr_thick_volume <-  cor(percentage_change_thickness[, 1:34], percentage_change_volume[, 1:34])
corr_area_volume <-  cor(percentage_change_area[, 1:34], percentage_change_volume[, 1:34])
...
plot = FigS6, width = 9, height = 6.5, units = 'in', dpi = 300, compression = "lzw")
...
Fig10 <- heatmaps_within[[1]] + heatmaps_within[[2]] + 
...
ggsave("/Users/wang/Library/CloudStorage/OneDrive-UniversityofBergen/Desktop/UiB/Manuscripts/BBSC/4.T1w_Image/Figures/Fig10.tiff",
plot = Fig10, width = 27, height = 18, units = 'in', dpi = 300, compression = "lzw")

# ggsave("/Users/joeywang/Library/CloudStorage/OneDrive-UniversityofBergen/Desktop/UiB/Manuscripts/BBSC/4.T1w_Image/Figures/Fig10.tiff",
#        plot = Fig10, width = 27, height = 18, units = 'in', dpi = 300, compression = "lzw")
