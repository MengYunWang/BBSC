...
sub3_lh[c(1,7), ] <- NA # delete the 1st and 7th, pay attention to the files that need to be saved
sub3_rh[c(1,7), ] <- NA # delete the 1st and 7th sessions because of the qc
...
# save the plots for the reuse to plot Fig. 3
# save(plots_brain_cv, file = "plots_brain_thickness_cv_orig.RData")
# save(plots_brain_mean, file = "plots_brain_thickness_mean_orig.RData") # save it for reuse

plots_brain_cv_qc <- plots_brain_cv
plots_brain_mean_qc <- plots_brain_mean
save(plots_brain_cv_qc, file = "plots_brain_thickness_cv_qc.RData")
save(plots_brain_mean_qc, file = "plots_brain_thickness_mean_qc.RData") # save it for reuse
...
# save(plots_list_box, file = "plots_brain_thickness_per_change_orig.RData")

plots_list_box_qc <- plots_list_box
save(plots_list_box_qc, file = "plots_brain_thickness_per_change_qc.RData")
