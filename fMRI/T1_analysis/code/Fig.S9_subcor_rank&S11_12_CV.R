# This code is to plot the Fig S9 and Fig. S11 S12
...
ggsave("/Users/wang/Library/CloudStorage/OneDrive-UniversityofBergen/Desktop/UiB/Manuscripts/BBSC/4.T1w_Image/Figures/FigS11_full.png",
       plot = FigS11, width = 13, height = 9, units = 'in', dpi = 300)

ggsave("/Users/wang/Library/CloudStorage/OneDrive-UniversityofBergen/Desktop/UiB/Manuscripts/BBSC/4.T1w_Image/Figures/FigS11_full_hd.png",
       plot = FigS11, width = 13, height = 9, units = 'in', dpi = 300)

# ggsave("/Users/wang/Library/CloudStorage/OneDrive-UniversityofBergen/Desktop/UiB/Manuscripts/BBSC/4.T1w_Image/Figures/FigS12_qc.png",
#        plot = FigS11, width = 13, height = 9, units = 'in', dpi = 300)
# 
# ggsave("/Users/wang/Library/CloudStorage/OneDrive-UniversityofBergen/Desktop/UiB/Manuscripts/BBSC/4.T1w_Image/Figures/FigS12_qc_hd.png",
#        plot = FigS11, width = 13, height = 9, units = 'in', dpi = 300)

# ggsave("/Users/joeywang/Library/CloudStorage/OneDrive-UniversityofBergen/Desktop/UiB/Manuscripts/BBSC/4.T1w_Image/Figures/FigS11.png",
#        plot = FigS11, width = 13, height = 9, units = 'in', dpi = 300)


#-------------------------------------Part III plot the data

load("sub_mean_volume_sub.RData") #from 10.1
load("sub_data_sets.RData") #generated from 10.1

plots_brain_mean <- lapply(sub_mean_volume_sub, function (df) {
...
plots_volume_ordered  <- lapply(names(data_sets), function(name) {
  df <- data_sets[[name]] %>%
    mutate(subject = name)
...
ggsave("/Users/wang/Library/CloudStorage/OneDrive-UniversityofBergen/Desktop/UiB/Manuscripts/BBSC/4.T1w_Image/Figures/FigS9_full.png",
       plot = FigS9, width = 10, height = 8.5, units = 'in', dpi = 100)

ggsave("/Users/wang/Library/CloudStorage/OneDrive-UniversityofBergen/Desktop/UiB/Manuscripts/BBSC/4.T1w_Image/Figures/FigS9_full_hd.png",
       plot = FigS9, width = 10, height = 8.5, units = 'in', dpi = 300)

# ggsave("/Users/joeywang/Library/CloudStorage/OneDrive-UniversityofBergen/Desktop/UiB/Manuscripts/BBSC/4.T1w_Image/Figures/FigS9.png",
#        plot = FigS9, width = 13, height = 9, units = 'in', dpi = 300)
