...
brain_regions <- colnames(percentage_change_volume[, 1:34]) %>%
  sort(decreasing = TRUE) %>%
  as.list()

##---generate the volume plots Fig.S1
...
plots_time_volume_sub1 <- generate_plots_for_subject("sub1")
plots_time_volume_sub2 <- generate_plots_for_subject("sub2")
plots_time_volume_sub3 <- generate_plots_for_subject("sub3")
...
volume_half1 <- combine_plots_for_range(1, 11, plots_time_volume_sub1, plots_time_volume_sub2, plots_time_volume_sub3)
volume_half2 <- combine_plots_for_range(12, 22, plots_time_volume_sub1, plots_time_volume_sub2, plots_time_volume_sub3)
volume_half3 <- combine_plots_for_range(23, 34, plots_time_volume_sub1, plots_time_volume_sub2, plots_time_volume_sub3)
