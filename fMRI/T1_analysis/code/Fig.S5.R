...
FigS5 <- (subcortex_half1) + plot_layout(guides = 'collect')
...
ggsave("/Users/wang/Library/CloudStorage/OneDrive-UniversityofBergen/Desktop/UiB/Manuscripts/BBSC/4.T1w_Image/Figures/FigS5.tiff",
       plot = FigS5, width = 13, height = 18, units = 'in', dpi = 300, compression = "lzw")
...
#        plot = FigS5, width = 14, height = 20, units = 'in', dpi = 300, compression = "lzw")
