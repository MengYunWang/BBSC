# This code is to plot the Fig.2
...
#---------------------plot the left side of the figure Fig.2AB
...
plots_brain_mean_qc[[3]] <- plots_brain_mean_qc[[3]] + 
...
plots_thickness_mean_ordered <- plots_brain_mean_qc[[1]] + plots_brain_mean_qc[[2]] + plots_brain_mean_qc[[3]] + 
...
#-------------------Plot the right bottom part of the figure, Fig.2D
...
Fig2 <- plots_thickness_mean_ordered | (plots_thickness_qc + plots_per_change_time[[1]] + plots_per_change_time[[2]] + 
                                          plots_per_change_time[[3]] + 
                                          plot_layout(design = design))

ggsave("/Users/wang/Library/CloudStorage/OneDrive-UniversityofBergen/Desktop/UiB/Manuscripts/BBSC/4.T1w_Image/Figures/Fig2.tiff",
