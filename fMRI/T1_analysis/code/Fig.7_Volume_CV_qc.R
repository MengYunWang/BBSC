...
Fig7 <- plots_brain_cv[[1]] + plots_brain_cv[[2]] + plots_brain_cv[[3]] + plots_brain_cv_qc[[3]] +
  plots_list_box[[1]] + plots_list_box[[2]] + plots_list_box[[3]]+ plots_list_box_qc[[3]] + plot_layout(ncol = 4)

ggsave("/Users/wang/Library/CloudStorage/OneDrive-UniversityofBergen/Desktop/UiB/Manuscripts/BBSC/4.T1w_Image/Figures/Fig7.tiff", 
...
# 
# plots_brain_cv[[3]] <- plots_brain_cv[[3]] +
#   scale_fill_viridis_c(option = "magma", direction = 1, limits = c(0, 6), breaks = c(0, 3, 6), labels = c("0", "3", "6")) +
#   theme(plot.margin = margin(t = 30, r = 2, b = 10, l = 2, unit = "pt"), legend.position = "none")
# 
# plots_brain_cv_qc[[3]] <- plots_brain_cv_qc[[3]] +
#   scale_fill_viridis_c(option = "magma", direction = 1, limits = c(0, 6), breaks = c(0, 3, 6), labels = c("0", "3", "6")) +
