...
FigS6 <-plots_brain_cv[[1]] + plots_brain_cv[[2]] + plots_brain_cv[[3]] +
...
#        plot = FigS6, width = 13, height = 9, units = 'in', dpi = 300, compression = "lzw")
...
#-------------------------------------Part III plot the data Fig. S15
...
FigS15 <- (plots_brain_mean[[1]] / plots_volume_ordered[[1]]) |
