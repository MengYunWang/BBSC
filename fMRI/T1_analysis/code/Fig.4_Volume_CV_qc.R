...
plots_brain_volume_cv_qc[[1]] <- plots_brain_volume_cv_qc[[1]] +
...
plots_brain_volume_cv_qc[[2]] <- plots_brain_volume_cv_qc[[2]] + 
...
plots_brain_volume_per_change_qc[[1]] <- plots_brain_volume_per_change_qc[[1]] + theme(axis.text.y = element_text(size = 18, family = "Arial",
                                                                              face = "bold", colour = "black"),
                                                   plot.margin = margin(t = 30, r = 2, b = 10, l = 2, unit = "pt"),
                                                   legend.position = "none")

plots_brain_volume_per_change_qc[[2]] <- plots_brain_volume_per_change_qc[[2]] + theme(axis.text.y = element_blank(), 
                                                   plot.margin = margin(t = 30, r = 2, b = 10, l = 2, unit = "pt"),
                                                   legend.position = "none")


plots_brain_volume_per_change_qc[[3]] <- plots_brain_volume_per_change_qc[[3]] + theme(axis.text.y = element_blank(), 
                                                         legend.title = element_blank(), 
