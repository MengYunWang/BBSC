# This code is to plot the distribution of metabolites in Sub2
...
MRS_water_tc_morning <- MRS_water_tc[morning_sub2, mrs_of_interest]
MRS_water_tc_afternoon <- MRS_water_tc[afternoon_sub2,mrs_of_interest]
